...
<h2>Confirm Deactivate User Profile</h2>

<form action='<%=getSubmitURL( user, view, oid )%>' method='POST'>
	
	<label>Are you sure you want to deactivate your account?</label>
	<input type='radio' name='deactivateUser' value='yes'/><span>Yes</span>
	<input type='radio' name='deactivateUser' value='no'/><span>No</span>
